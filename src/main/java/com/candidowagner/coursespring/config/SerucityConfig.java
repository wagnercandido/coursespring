...
import com.candidowagner.coursespring.security.JWTAuthenticationFilter;
import com.candidowagner.coursespring.security.JWTAuthorizationFilter;
...
public class SerucityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_ROUTES_GET = { "/produtos/**", "/categorias/**", "/clientes/**", };
