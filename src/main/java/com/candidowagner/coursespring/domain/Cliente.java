...
public class Cliente implements Serializable {
	...
	@ElementCollection // TODO Tabela fraca para armazenar telefones sem os ID's próprios
	@CollectionTable(name="TELEFONE")
	private Set<String> telefones = new HashSet<>(); // O Set é uma lista que não permite repetição
